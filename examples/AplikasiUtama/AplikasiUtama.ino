...
void planning3(){    
  ...
  iota.setPlan(10, BLACK_LINE, ALL_SENSOR_NOT_DETECT, TURN_LEFT, 1300, 200, PID_LOW); 
  iota.setPlan(11, BLACK_LINE, RIGHT_DETECT, TURN_RIGHT, 800, 255, PID_NORMAL); 
  iota.setPlan(12, BLACK_LINE, LEFT_RIGHT_DETECT, FORWARD, 0, 0, PID_NORMAL); 
  iota.setPlan(13, WHITE_LINE, ACTION_NO_SENSOR, NO_ACTION, 100, 250, PID_NORMAL); 

  iota.setFinish(13, AFTER_TIMER);
